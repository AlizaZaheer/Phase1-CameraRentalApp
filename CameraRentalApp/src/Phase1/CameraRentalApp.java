...
public class CameraRentalApp {
    ...
    private static void manageMyCamera(Scanner scanner, boolean displayMainMenu) {
            ...
            switch (choice) {
                case 1:
                    addCamera(scanner);
                    manageMyCamera(scanner, false);// if we use true then the it will break and not excecute other
                    break;
                case 2:
    ...
    private static void viewMyCameras() {
        ...
        if (cameraList.isEmpty()) {
        	...
        	System.out.printf("%-10s %-10s %-10s %-10s %-10s\n",
                    "CAMERA ID", "BRAND", "MODEL", "PRICE(Per day)", "STATUS");//%-10s it iused for holding the data.
        	System.out.println(       "---------------------------------------------------");
            int id = 0;
